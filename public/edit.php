...
<body>
    <div class=" 12u recipe edit">
        <div class=" card card-body 12u 12u(mobilep) " style="color:black">
            <form method="POST">
                <p style="margin-bottom:15px;text-align:center;cursor:pointer;font-size:1.8rem" class="  detail">
                    <?php echo $_POST['recipe_title']; ?>
                </p>
                <div class="row uniform 50%">
                    ...
                    <div class="12u">
                        <button name="add" id="add_recipe" class="button  special add-recipe" style="text-align:center;float:right">Submit</button>
                        <button id="remove" class="button alt " style="text-align:center; ">Delete</button>
